        ...
        >
            ...
            <Modal.Body>
                ...
                <Dropdown className="mb-3" style={{margin: "0 auto"}}>
                    ...
                    <Dropdown.Menu>
                        {brandOrType === "Brand" ? <Dropdown.Item disabled>Бренд</Dropdown.Item> : <Dropdown.Item onClick={() => setBrandOrType("Brand")}>Бренд</Dropdown.Item>}
                        {brandOrType === "Type" ? <Dropdown.Item disabled>Тип</Dropdown.Item> : <Dropdown.Item onClick={() => setBrandOrType("Type")}>Тип</Dropdown.Item>}
                    </Dropdown.Menu>
                </Dropdown>
