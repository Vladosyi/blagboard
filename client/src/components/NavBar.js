        ...
        <div className="first-container">
          ...
          <div className="container1">
            ...
            <div className="market">
              <a className="market-text" href={SHOP_ROUTE} target="_blank">
                Магазин
              </a>
            </div>
            <div className="about-us">
              <p className="about-us-p">О нас</p>
            </div>
            <div className="support">
              <p className="support-p">Поддержка</p>
            </div>
            <div className="location">Благовещенск</div>
          </div>
