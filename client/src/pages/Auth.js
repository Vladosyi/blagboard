    ...
    return(
      <div className='first-div'>
        ...
        <form className='form-continer-first'>
          <div className='form'>
           {isLogin ?
           <p className='p-Login' href={REGISTRATION_ROUTE}>Login</p>
           :
            <p className='p-Login' href={LOGIN_ROUTE}>Sing in</p>
           }
              ...
              <div onClick={click} className='btn'>Логин</div>
            <div className='second-big-box'>
              {isLogin ? <div className='registration-post'>
                    Нет аккаунта? <a className='registration' href={REGISTRATION_ROUTE}>Регистрация</a>
                </div>
                :
                <div className='registration-post'>
                    Есть аккаунт?? <a className='registration' href={LOGIN_ROUTE}>Логин</a>
                </div>
              }
              </div>
            <div className='second-big-box-blagboard'>
              <div>
                <a className='blagboard' href={SHOP_ROUTE} >BLAGBOARD SHOP</a>
              </div>
            </div>
          </div>
        </form>
