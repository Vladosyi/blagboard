        ...
        <div className="container-devicePage-first">
            <div className="container-DevicePage">
                <div className="devicePage-img">
                    <img className="devicePage-img-main" src={process.env.REACT_APP_API_URL + device.img} alt="First slide"/>
                    <div className="deviceName">
                        <div className="deviceName-container">
                            <h2 className="deviceName-word">{device.name}</h2>
                            <div className="container-devicepage-between"> 
                        </div>
                        </div>
                        <div className="aracteristics-contahiner">
                            <div className="haracteristics-text">
                                Характеристики:
                            </div>
                        ...
                        <div className="price-container">
                            <div className="praice-container-word">Цена: {device.price} рублей </div>
                        </div>
